...
- `run_project1.py`: rutas, lista explícita `CASE_IDS` y punto de entrada.
- `nlp_utils.py`: limpieza, segmentación, tokenización, normalización y reglas
  de medición implementadas con funciones, diccionarios y regex.
- `pipeline.py`: carga, validación, ejecución, nodos, CSV, JSON y Mermaid.
- `tests/test_project1.py`: pruebas de mediciones, negativos, offsets,
  segmentación y tokens.
...
- `results/iteration_1/mermaid/PMC5137649_01.mmd`
- `results/iteration_1/mermaid/PMC11722600_01.mmd`
- `results/iteration_1/mermaid/PMC11783470_01.mmd`
- `results/iteration_1/mermaid/PMC2817501_01.mmd`
- `results/iteration_1/mermaid/PMC11368112_01.mmd`
